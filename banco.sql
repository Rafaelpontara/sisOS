...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `motivo_bloqueio`  VARCHAR(300) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `categorias` (
  ...
  INDEX `fk_categorias_parent` (`parent_id` ASC),
...
CREATE TABLE IF NOT EXISTS `os` (
  ...
  `os_origem_id`         INT(11) NULL DEFAULT NULL,
  `situacao_financeira`  VARCHAR(20) NULL DEFAULT 'pendente',
  `data_retirada`        DATE NULL DEFAULT NULL,
  `checklist`            TEXT NULL DEFAULT NULL,
  `checklist_fotos`      TEXT NULL DEFAULT NULL,
  `is_recorrente`        TINYINT(1) NOT NULL DEFAULT 0,
  `recorrencia_tipo`     VARCHAR(20) NULL DEFAULT NULL,
  `recorrencia_proxima`  DATE NULL DEFAULT NULL,
  `equipamento`          VARCHAR(150) NULL DEFAULT NULL,
  `numeroSerie`          VARCHAR(80)  NULL DEFAULT NULL,
  PRIMARY KEY (`idOs`),
...
CREATE TABLE IF NOT EXISTS `produtos` (
  ...
  `foto`          VARCHAR(300) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `estoque_movimentacoes` (
  ...
  `origem`         VARCHAR(40) NULL DEFAULT NULL,
...
('Aparelho ligando', 1), ('Tela sem trincas ou manchas', 2),
('Bateria em boas condições', 3), ('Carregador entregue', 4),
('Capa protetora entregue', 5), ('Botões funcionando', 6),
('Câmera sem danos', 7), ('Sem oxidação visível', 8), ('Acessórios conferidos', 9);
...
('Bronze','#cd7f32','Plano Bronze'),('Prata','#a8a9ad','Plano Prata'),
('Ouro','#ffd700','Plano Ouro'),('VIP','#9b59b6','Cliente VIP'),
('Contrato','#2980b9','Possui contrato ativo');

-- -----------------------------------------------------
-- Table `clientes_tags` (relação N:N)
-- -----------------------------------------------------
