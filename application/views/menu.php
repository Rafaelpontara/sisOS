    ...
    <div class="menu-bar">
        <div class="menu">
            <ul class="menu-links" style="position:relative;">
                ...
                <li class="<?php if (isset($menuChat)) echo 'active'; ?>">
                    <a data-g="green" class="tip-bottom" href="<?= site_url('chat') ?>">
                        <i class='bx bx-chat iconX'></i>
                        <span class="title">Chat da Equipe</span>
                        <span class="title-tooltip">Chat da Equipe</span>
                    </a>
                </li>
