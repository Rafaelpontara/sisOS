...
<body>
  ...
  ?>
      ...
      <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="SISOS - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
            ...
            <div class="card">
              <div class="content">
                <div id="newlog">
                  ...
                  <div class="title01">
                    <?= '<img src="' . base_url() . 'assets/img/logo-sisos-branco.png">'; ?>
                  </div>
                </div>
                ...
                <div class="links-uteis"><a href="https://github.com/Rafaelpontara/sisos">
                    <p><?= date('Y'); ?> &copy; Rafael</p>
                  </a>
                </div>
                <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal" style="display: none ">notification</a>
                <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-header">
                    <h4 id="myModalLabel">SISOS</h4>
                  </div>
          ...
          $.ajax({
            ...
            success: function(data) {
                if (data.result == true) {
                    ...
                    var newCsrfToken = data.SISOS_TOKEN; 
