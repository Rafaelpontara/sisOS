...
if (($result->faturado != 1 || $editavel) && $this->permission->checkPermission($this->session->userdata('permissao'), 'eVenda')): ?>
                        ...
                        <div class="button-container">
                            ...
                            <div class="cascading-buttons">
                                ...
                                <a target="_blank" title="Nota Promissória" class="button btn btn-mini btn-warning" href="<?php echo site_url() ?>/vendas/imprimirPromissoria/<?php echo $result->idVendas; ?>">
                                    <span class="button__icon"><i class="bx bx-file-blank"></i></span><span class="button__text">Promissória</span>
                                </a>
                                ...
                                <div class="invoice-head" style="margin-bottom: 0; margin-top:-30px">
                                    <table class="table table-condensed">
                                        <tbody>
                                            <?php if ($emitente == null) { ?>
                                                <tr>
                                                    <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/sisos/emitente">Configurar <<< </a></td>
                                                </tr>
                                            <?php } ?>
