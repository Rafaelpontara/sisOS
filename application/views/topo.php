...
<style>
/* ══════════════════════════════════════════════════════════════════
   TEMA CLARO — Cabeçalho (topo.php). A barra superior (#user-nav) e
   os menus suspensos usam a paleta escura fixa do template Matrix,
   que o tema-white.css não cobre por completo. Sobrescreve só quando
   o tema ativo é claro; não altera nada do tema escuro.
   ══════════════════════════════════════════════════════════════════ */
