    ...
    <div class="vv-card">
        ...
        <div class="vv-totals">
            ...
            <div class="vv-total-row">
                ...
                <div class="vv-total-val" style="color:#f87171;">- R$ <?= number_format(floatval($result->desconto) > 0 ? floatval($result->desconto) : ($totalProdutos - floatval($result->valor_desconto)), 2, ',', '.') ?></div>
            </div>
