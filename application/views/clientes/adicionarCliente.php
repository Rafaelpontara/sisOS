...
.cli-btn-cep{display:inline-flex;align-items:center;gap:4px;padding:7px 12px;background:rgba(251,191,36,0.12);color:#fbbf24;border:1px solid rgba(251,191,36,0.3);border-radius:8px;font-size:12px;font-weight:700;cursor:pointer;white-space:nowrap;transition:all .15s;border-top:none;border-left:none;border-right:none;}
.cli-btn-cep:hover{background:rgba(251,191,36,0.22);}
...
.cli-btn-save{background:linear-gradient(135deg,#22c55e,#16a34a);color:#fff;box-shadow:0 4px 12px rgba(34,197,94,0.3);}
                ...
                <div class="cli-grid-2" style="margin-bottom:14px;">
                    <div>
                        ...
                        <div class="cli-input-group">
                            <input id="documento" type="text" name="documento" class="cli-input cpfcnpj"
                                   value="<?= set_value('documento') ?>" placeholder="000.000.000-00" />
                    ...
                    <div>
                        ...
                        <input id="nomeCliente" type="text" name="nomeCliente" class="cli-input"
                               value="<?= set_value('nomeCliente') ?>" placeholder="Nome completo ou razão social" />
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="cli-pass-wrap">
                            <input id="senha" type="password" name="senha" class="cli-input"
                                   value="<?= set_value('senha') ?>" autocomplete="new-password"
                ...
                <div style="margin-bottom:14px;">
                    ...
                    <div class="cli-cep-group">
                        <input id="cep" type="text" name="cep" class="cli-input"
                               value="<?= set_value('cep') ?>" placeholder="00000-000" style="max-width:160px;" />
