                ...
                <div class="ev-tbl-wrap">
                    <table class="ev-tbl" id="tblProdutos">
                        ...
                        <tfoot>
                            ...
                            <?php
                                // desconto = valor em R$ descontado
                                // valor_desconto = total final
                                $descontoExib = floatval($result->desconto);
                                $totalFinalExib = floatval($result->valor_desconto);
                            ?>
                            <tr><td colspan="4" style="text-align:right;color:#9ca3af;">Desconto:</td><td style="text-align:right;color:#f87171;">- R$ <?= number_format($descontoExib, 2, ',', '.') ?></td></tr>
                            <tr><td colspan="4" style="text-align:right;color:#9ca3af;">Total c/ Desconto:</td><td style="text-align:right;font-size:15px;color:#4ade80;">R$ <?= number_format($totalFinalExib, 2, ',', '.') ?></td></tr>
                            <?php endif; ?>
                        </tfoot>
                    </table>
                </div>
