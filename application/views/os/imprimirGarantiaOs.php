...
<head>
    <title><?= $this->config->item("app_name") ?> - Garantia OS</title>
    <meta charset="UTF-8" />
    ...
    <style>
        ...
        * {
        ...
        /* ══ Termo de Garantia (OS) — formatação moderna ══ */
    ...
    <div class="container-fluid page" id="viaCliente">
        <div class="subpage tg-doc">
            ...
            <div class="tg-header">
                ...
                <div class="tg-meta">
                    <strong>Garantia OS: <?= $osGarantia->idOs ? $osGarantia->idOs : "" ?></strong>
                    Emissão: <?= $osGarantia->osDataFinal ? date('d/m/Y', strtotime($osGarantia->osDataFinal)) : "" ?>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="tg-corpo"><?php echo printSafeHtml($osGarantia->textoGarantia) ?></div>
