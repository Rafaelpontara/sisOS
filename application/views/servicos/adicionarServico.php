...
<div class="df-wrap new122">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px;flex-wrap:wrap;gap:10px;">
        <h2 style="font-size:18px;font-weight:800;color:#e8eaf0;display:flex;align-items:center;gap:8px;"><i class='bx bx-wrench' style="color:#22c55e;"></i> Cadastro de Serviço</h2>
    ...
    <div class="df-card">
        <div class="df-card-head"><i class='bx bx-wrench' style="color:#22c55e;"></i><span>Dados do Serviço</span></div>
        <div class="df-card-body">
            <form action="<?= current_url() ?>" id="formServico" method="post">
                <div class="df-field"><label class="df-label">Nome <span class="req">*</span></label><input id="nome" type="text" name="nome" class="df-input" value="<?= set_value('nome') ?>" required placeholder="Ex: Limpeza, Troca de tela..."></div>
                <div class="df-field"><label class="df-label">Preço <span class="req">*</span></label><input id="preco" class="df-input money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="preco" value="<?= set_value('preco') ?>" required placeholder="0.00"></div>
                <div class="df-field"><label class="df-label">Descrição</label><input id="descricao" type="text" name="descricao" class="df-input" value="<?= set_value('descricao') ?>" placeholder="Breve descrição do serviço (opcional)"></div>
                <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:8px;">
                    <a href="<?= base_url() ?>index.php/servicos" class="df-btn df-btn-back"><i class='bx bx-x'></i> Cancelar</a>
                    <button type="submit" class="df-btn df-btn-save" id="btnSalvar"><i class='bx bx-plus-circle'></i> Cadastrar</button>
                </div>
            </form>
        </div>
    </div>
