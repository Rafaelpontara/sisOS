...
<div class="p-card" style="border-color:rgba(167,139,250,0.3);margin-bottom:16px;">
    <div class="p-card-head" style="background:rgba(167,139,250,0.08);">
        <div class="p-card-head-left">
            <i class='bx bx-happy-heart-eyes' style="color:#a78bfa;"></i>
            <span style="color:#a78bfa;">Avalie seu atendimento</span>
        </div>
        <span style="background:rgba(167,139,250,0.2);color:#a78bfa;font-size:11px;font-weight:700;padding:2px 8px;border-radius:10px;">
            <?= count($pesquisasPendentes) ?>
        </span>
    </div>
    <div class="p-card-body" style="padding:14px;">
        <div style="display:flex;flex-direction:column;gap:10px;">
            <?php foreach ($pesquisasPendentes as $p): ?>
            <div style="display:flex;align-items:center;justify-content:space-between;gap:10px;background:#161925;border-radius:10px;padding:10px 14px;flex-wrap:wrap;">
                <div>
                ...
                <a href="<?= site_url('mine/pesquisa/' . $p->idOs) ?>" target="_blank"
                   class="p-btn" style="background:linear-gradient(135deg,#a78bfa,#7c3aed);color:#fff;padding:7px 14px;font-size:12.5px;">
                    <i class='bx bx-star'></i> Avaliar Atendimento
                </a>
            </div>
            <?php endforeach; ?>
        </div>
