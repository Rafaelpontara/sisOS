...
class Relatorios extends MY_Controller
{
    ...
    public function osCustom()
    {
        ...
        $referencia = $this->input->get('referencia') ?: null;

        $isXls = $format === 'xls';
        $os = $this->Relatorios_model->osCustom($dataInicial, $dataFinal, $cliente, $responsavel, $status, $isXls, $descricao, $referencia);
        $totalProdutos = 0;
        $totalServicos = 0;
        $totalDesconto = 0;
        $totalValorDesconto = 0;
    ...
    public function vendasCustom()
    {
        ...
        $isXls = $format === 'xls';
        $vendas = $this->Relatorios_model->vendasCustom($dataInicial, $dataFinal, $cliente, $responsavel, $isXls, $descricao);
        $totalVendas = 0;
        $totalDesconto = 0;
        $totalValorDesconto = 0;
        foreach ($vendas as $venda) {
