...
class Github_updater
{
    ...
    public function update()
    {
        ...
        if ($hash !== $this->ci->config->item('current_commit')) {
            ...
            if ($dir = $this->_get_and_extract($hash)) {
                ...
                // Update the sisos version in the config filename
    ...
    /**
     * Get sisos current version.
     *
     * @return string Sisos current version.
     */
    private function getCurrentVersion()
    {
        ...
        if (! $version) {
            throw new Exception('Error getting sisos version from GitHub!');
        }
