...
em baixo em 'Adicione argumentos' coloque o comando do sisos para processar a fila de e-mails 'index.php email/process' na próxima opção 'Iniciar em' coloque o diretório onde está a pasta do seu sisos desta forma (Para o Xampp) 'C:\xampp\htdocs\sisos' e clique em 'Ok':
