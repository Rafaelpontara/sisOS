...
- Usando $_SERVER["HTTP_AUTHORIZATION"] para o App autenticar no sisos na rede local. [@juliolobo](https://github.com/juliolobo)
...
### Added
- Auto Instalador SISOS Ubuntu/Debian. [@barretowiisk](https://github.com/barretowiisk)
...
- Corrigido case "Negociação" onde faltava a cor e o break no codigo em os.php e Sisos.php. [@willph](https://github.com/willph)
...
## Added
- Adicionando relatório de clientes em xls. [@RamonSilva20](https://github.com/Rafaelpontara)

## [4.10.0] - 2020-07-01

## Added
- Adicionando suporte a HMVC. [@RamonSilva20](https://github.com/Rafaelpontara)

## Fixed
- Corrigindo erro na listagem quando arquivo não encontrado. [@RamonSilva20](https://github.com/Rafaelpontara)
...
## Changed
- Melhoria em mensagem de erro pasta faltante system. [@RamonSilva20](https://github.com/Rafaelpontara)
...
### Fixed
- Corrigido email de cliente no lugar de vendedor. [@RamonSilva20](https://github.com/Rafaelpontara)
- Corrigido problema na tela de listagem de OS com garantia não numérica. [@RamonSilva20](https://github.com/Rafaelpontara)

## [4.1.0] - 2020-03-04

### Fixed
- Corrigido layout e links de anexos de OS. [@RamonSilva20](https://github.com/Rafaelpontara)
- Corrigido problema no layout de etiquetas. [@RamonSilva20](https://github.com/Rafaelpontara)
- Corrigido layout e problema ao salvar pagamento. [@RamonSilva20](https://github.com/Rafaelpontara)

## Changed
- Anexos de OS estruturados dentro de pastas MM-AAAA/OS-#ID. [@RamonSilva20](https://github.com/Rafaelpontara)
...
### Added
- Adicionado opções de configuração do sistema. [@RamonSilva20](https://github.com/Rafaelpontara)
...
### Fixed
- Corrigido arquivo de configurações. [@RamonSilva20](https://github.com/Rafaelpontara)
...
### Changed
- Atualização da versão do Codeigniter para 3.1.11. [@RamonSilva20](https://github.com/Rafaelpontara)
- Refatoramento de controllers para diminuir repetição de código. [@RamonSilva20](https://github.com/Rafaelpontara)
- Simplificado exibição de mensagem de acesso expirado. [@RamonSilva20](https://github.com/Rafaelpontara)
- Remoção de data e hora no menu superior. [@RamonSilva20](https://github.com/Rafaelpontara)
...
### Changed
- Refatoramento de listagens de cadastros. [@RamonSilva20](https://github.com/Rafaelpontara)
...
- Corrigido problema de return-path ao utilizar SMTP. [@RamonSilva20](https://github.com/Rafaelpontara)
- Corrigido erro no link de WhatsApp ao não ter cadastro de emitente. [@RamonSilva20](https://github.com/Rafaelpontara)
...
### Added
- Adicionado anotações na OS. [@RamonSilva20](https://github.com/Rafaelpontara)
...
- Corrigido arquivo de update de data de expiração com data futura. [@RamonSilva20](https://github.com/Rafaelpontara)

## [3.8.0] - 2019-07-25

### Added
- Adicionada pesquisa por múltiplos status em OS. [@RamonSilva20](https://github.com/Rafaelpontara)
- Ao adicionar OS e Vendas usuário logado preenchido por padrão como responsável. [@RamonSilva20](https://github.com/Rafaelpontara)
...
### Added
- Adicionada funcionalidade de envio de OS por email. [@RamonSilva20](https://github.com/Rafaelpontara)

## [3.6.0] - 2019-06-29

### Added
- Adicionada verificação de permissão para exibição de estatísticas no painel. [@RamonSilva20](https://github.com/Rafaelpontara)
- Adicionada possibilidade de alteração de preços de produtos e serviços em OS. [@RamonSilva20](https://github.com/Rafaelpontara)
- Adicionada possibilidade de adicionar quantidade de serviços em OS. [@RamonSilva20](https://github.com/Rafaelpontara)
- Adicionada possibilidade de alterar preços de produtos em Vendas. [@RamonSilva20](https://github.com/Rafaelpontara)

### Changed
- Modificados alguns elementos de estilização. [@RamonSilva20](https://github.com/Rafaelpontara)

## [3.5.3] - 2019-05-18

### Fixed
- Corrigido remoção de garantias ao editar OS. [@RamonSilva20](https://github.com/Rafaelpontara) e [@willph](https://github.com/willph)
...
### Fixed
- Corrigido pesquisa de termos de garantia. [@RamonSilva20](https://github.com/Rafaelpontara).
- Corrigido erro no cadastro de garantias ao buscar nome do usuário logado. [@RamonSilva20](https://github.com/Rafaelpontara).
...
### Fixed
- Removendo obrigatoriedade do campo de garantias na tabela de OS para evitar erro ao não preencher no cadastro. [@RamonSilva20](https://github.com/Rafaelpontara).

### Changed
- Alterado insert de usuário com permissão para o módulo de auditoria no arquivo sql. [@RamonSilva20](https://github.com/Rafaelpontara)

## [3.5.0] - 2019-05-12

### Added
- Adicionado modulo de auditoria para monitoramento de atividades no sistema. [@RamonSilva20](https://github.com/Rafaelpontara).
...
## [3.1.16] - 2019-01-14
### Added
- Adicionado e-mail do cliente na impressão da OS. [@RamonSilva20](https://github.com/Rafaelpontara).

### Fixed
- Corrigido alteração de senha na tela minha conta [@RamonSilva20](https://github.com/Rafaelpontara).
- Corrigido link no formulário de adicionar arquivo. [@RamonSilva20](https://github.com/Rafaelpontara).

## [3.1.15] - 2018-11-24
### Fixed
- Corrigido campo descrição na impressão e visualização de OS [@RamonSilva20](https://github.com/Rafaelpontara).

## [3.1.14] - 2018-11-13
### Added
- Modelo de impressão de OS otimizando espaços [@RamonSilva20](https://github.com/Rafaelpontara).
...
- Arquivo de changelog [@RamonSilva20](https://github.com/Rafaelpontara).


## [3.1.12] - 2018-08-14
### Added
- Valor total no relatório de OS [@RamonSilva20](https://github.com/Rafaelpontara).
...
### Fixed
- Correção de erro ao gerar relatório sem emitente estar configurado [@RamonSilva20](https://github.com/Rafaelpontara).
